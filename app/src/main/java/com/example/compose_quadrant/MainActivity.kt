...
import com.example.compose_quadrant.R
    ...
    Column(Modifier.fillMaxWidth()) {
        Row(Modifier.weight(1f)) {
            ComposableInfoCard(
                ...
                description = stringResource(R.string.descr_first),
                backgroundColor = Color(0xFFEADDFF),
                modifier = Modifier.weight(1f)
            )
            ComposableInfoCard(
                title = stringResource(R.string.title_second),
                description = stringResource(R.string.descr_second),
        ...
        Row(Modifier.weight(1f)) {
            ComposableInfoCard(
                ...
                description = stringResource(R.string.descr_third),
                backgroundColor = Color(0xFFB69DF8),
                modifier = Modifier.weight(1f)
            )
            ComposableInfoCard(
                title = stringResource(R.string.title_fourth),
                description = stringResource(R.string.descr_fourth),
